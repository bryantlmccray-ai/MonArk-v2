    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-muted-foreground text-sm leading-relaxed max-w-sm mx-auto font-medium">
          Smart Matching has noticed great chemistry in your conversation with {matchName}. Let us create a personalized date experience that brings out the best in both of you.
        </p>
      </div>
      ...
      <div className="flex space-x-4 pt-2">
        ...
        <Button onClick={handleGenerateProposal} className="flex-1">Plan This!</Button>
      </div>
    </div>
  );
    ...
    <div className="space-y-8 text-center py-12">
      ...
      <div>
        ...
        <p className="text-muted-foreground text-sm max-w-sm mx-auto leading-relaxed font-medium">
          {matchName} will receive your thoughtful date idea. You will both be notified when they respond.
        </p>
      </div>
    </div>
  );
