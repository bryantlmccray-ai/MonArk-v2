...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-center rounded-xl bg-secondary/80 p-1 text-muted-foreground gap-1",
      className
    )}
    {...props}
  />
