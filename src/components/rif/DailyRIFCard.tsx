        ...
        return (
                  <div className="bg-card border border-primary/20 rounded-2xl p-4 shadow-sm">
                        ...
                        {todayQuestion.subtext && (
                                <p className="text-xs text-muted-foreground italic mb-3">{todayQuestion.subtext}</p>p>
                        )}
                        <AnimatePresence>
                        ...
                        {saveMutation.isError && (
                                <p className="text-xs text-destructive mt-2">Could not save, please try again.</p>p>
                        )}
                  </div>div>
                );
}
