    ...
    <div className="min-h-screen bg-[hsl(230_18%_14%)] flex flex-col items-center overflow-y-auto pb-16">
      <div className="w-full max-w-lg px-5 pt-10 space-y-5">
        ...
        >
          ...
          <h1 className="text-2xl font-serif text-[hsl(30_40%_85%)] font-bold">Your Relational Profile is ready</h1>
          <p className="text-sm text-[hsl(240_6%_55%)]">Here's how you show up in relationships</p>
        </motion.div>
        ...
        >
          <p className="text-xs uppercase tracking-widest text-[hsl(240_6%_45%)] font-medium">Your Archetype</p>
          <h2 className="text-xl font-serif text-[hsl(30_40%_72%)] font-bold">{archetype.name}</h2>
          <p className="text-sm text-[hsl(240_6%_65%)] leading-relaxed">{archetype.description}</p>
          <div className="border-t border-[hsl(230_18%_25%)] pt-3">
            <p className="text-sm text-[hsl(30_40%_80%)] leading-relaxed italic">"{archetype.narrative}"</p>
          </div>
        </motion.div>
        ...
        <AnimatePresence>
          {showDimensions && (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-3">
              <p className="text-xs uppercase tracking-widest text-[hsl(240_6%_45%)] font-medium text-center">Your Dimensions</p>
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-medium text-[hsl(30_40%_85%)]">{dim.label}</span>
                      </div>
                      <span className={`text-sm font-bold ${dim.textColor}`}>{score}/10</span>
                    </div>
                    ...
                    <p className="text-xs text-[hsl(240_6%_55%)]">{getDimensionInsight(score, dim)}</p>
                  </motion.div>
                );
              })}
            </motion.div>
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <p className="text-sm font-semibold text-[hsl(30_40%_85%)]">Who you pair best with</p>
          </div>
          <p className="text-sm text-[hsl(240_6%_60%)] leading-relaxed">{archetype.compatibility}</p>
        </motion.div>
