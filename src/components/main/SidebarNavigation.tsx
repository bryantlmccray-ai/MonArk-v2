...
import { User, MessageCircle, BookOpen, Calendar, Crown, Brain, LogOut, Compass, Navigation } from 'lucide-react';
...
export const SidebarNavigation: React.FC<SidebarNavigationProps> = ({
    ...
    // 6 tabs — desktop sidebar aligned with mobile BottomNavigation
