...
export const SidebarNavigation: React.FC<SidebarNavigationProps> = ({ activeTab, onTabChange, onArkNavigation, onUpgrade }) => {
    ...
    // 7 tabs — aligned with mobile BottomNavigation (6 tabs) + Milestone Cards desktop-only
    const tabs = [
      { id: 'weekly',     icon: Calendar,       label: 'Your 3',            hasNotification: false },
      { id: 'discover',   icon: Compass,        label: 'Discover',          hasNotification: false },
      { id: 'matches',    icon: MessageCircle,  label: 'Chats',             hasNotification: true  },
          ...
          <Sidebar className="border-r border-sidebar-border">
                <SidebarHeader className="border-b border-sidebar-border p-6">
                        <div className="flex flex-col items-center gap-2">
                                  ...
                                  <span className="text-xs font-medium text-sidebar-foreground/80 tracking-wide">{displayName}</span>span>
                ...
                <SidebarContent>
                            ...
                            return (
                                                <SidebarMenuItem key={tab.id}>
                                                                    <SidebarMenuButton
                                                                                          ...
                                                                                          <span className="tracking-wide">{tab.label}</span>span>
                  ...
                  {/* Upgrade Button — only show if user is not already on Inner Ark */}
                                                ...
                                                <SidebarMenu>
                                                                <SidebarMenuItem>
                                                                                  <SidebarMenuButton
                                                                                                      ...
                                                                                                      <span>Join the Inner Ark</span>span>
                                                                                    </SidebarMenuButton>SidebarMenuButton>
                                                                </SidebarMenuItem>SidebarMenuItem>
                                                </SidebarMenu>SidebarMenu>
                                  </SidebarGroupContent>SidebarGroupContent>
                        ...
                        <SidebarMenu>
                                  <SidebarMenuItem>
                                              <SidebarMenuButton
                                                            ...
                                                            <span className="tracking-wide">Sign Out</span>span>
                                              </SidebarMenuButton>SidebarMenuButton>
                                  </SidebarMenuItem>SidebarMenuItem>
                        </SidebarMenu>SidebarMenu>
