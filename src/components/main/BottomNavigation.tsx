...
import { User, MessageCircle, BookOpen, Calendar, Compass, Brain, Search } from 'lucide-react';
...
export const BottomNavigation: React.FC<BottomNavigationProps> = ({ activeTab, onTabChange }) => {
    ...
    const tabs = [
      ...
      { id: 'discover', icon: Search,        label: 'Discover', badge: 0 },
      ...
      { id: 'profile',  icon: User,          label: 'Me',       badge: rifNotComplete ? 1 : 0 },
        ];
