...
const prototypeProfiles: (DiscoveryProfile & { profiles?: { name: string } })[] = [
  {
    ...
    exercise_habits: 'Active (3-4 times/week)',
  ...
  },
  {
    ...
    age_verified: true,
    age_verification_timestamp: new Date().toISOString(),
    relationship_goals: ['Casual dating', 'New friends'],
    occupation: 'Yoga Instructor',
    education_level: 'Some College',
    exercise_habits: 'Very active (5+ times/week)',
    smoking_status: 'Never',
    drinking_status: 'Rarely',
    height_cm: 165,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    distance: 4.1,
  ...
  },
  {
    ...
    age_verified: true,
    age_verification_timestamp: new Date().toISOString(),
    relationship_goals: ['Serious relationship', 'Life partner'],
    occupation: 'Product Designer',
    education_level: "Master's Degree",
    exercise_habits: 'Moderate (1-2 times/week)',
    smoking_status: 'Never',
    drinking_status: 'Socially',
    height_cm: 172,
    created_at: new Date().toISOString(),
