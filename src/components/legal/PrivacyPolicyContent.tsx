    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="grid gap-6">
        ...
        <Card className="border-border">
          ...
          <CardContent className="text-muted-foreground space-y-4">
            <div className="space-y-4">
              <div>
                <h4 className="text-foreground font-medium mb-2">Profile Information</h4>
              ...
              <div>
                <h4 className="text-foreground font-medium mb-2">Usage Data</h4>
                <ul className="list-disc list-inside space-y-1 ml-4 text-sm">
              ...
              <div>
                <h4 className="text-foreground font-medium mb-2">Emotional Wellness Data</h4>
                <ul className="list-disc list-inside space-y-1 ml-4 text-sm">
        ...
        <Card className="border-border">
          ...
          <CardContent className="text-muted-foreground space-y-4">
            <div className="space-y-4">
              ...
              <div>
                <h4 className="text-foreground font-medium mb-2">Platform Improvement</h4>
                <ul className="list-disc list-inside space-y-1 ml-4 text-sm">
              ...
              <div>
                <h4 className="text-foreground font-medium mb-2">Communication</h4>
                <ul className="list-disc list-inside space-y-1 ml-4 text-sm">
          ...
          <CardContent className="text-muted-foreground space-y-4">
            ...
            <div className="space-y-4">
              <div className="bg-muted/50 rounded-lg p-4">
                <h4 className="text-foreground font-medium mb-2">Essential Cookies</h4>
                <p className="text-sm text-muted-foreground">
              ...
              <div className="bg-muted/50 rounded-lg p-4">
                <h4 className="text-foreground font-medium mb-2">Analytics Cookies</h4>
                <p className="text-sm text-muted-foreground">
              ...
              <div className="bg-muted/50 rounded-lg p-4">
                <h4 className="text-foreground font-medium mb-2">Preference Cookies</h4>
                <p className="text-sm text-muted-foreground">
        ...
        <Card className="border-border">
          ...
          <CardContent className="text-muted-foreground space-y-4">
            <div className="bg-primary/5 border border-primary/20 rounded-lg p-4">
              <h4 className="text-primary font-medium mb-2">Our Commitment</h4>
            ...
            <div className="space-y-4">
              <div>
                <h4 className="text-foreground font-medium mb-2">When We May Share Data</h4>
                <ul className="list-disc list-inside space-y-1 ml-4 text-sm">
              ...
              <div>
                <h4 className="text-foreground font-medium mb-2">How We Protect Your Data</h4>
                <ul className="list-disc list-inside space-y-1 ml-4 text-sm">
        ...
        <Card className="border-border">
          ...
          <CardContent className="text-muted-foreground space-y-4">
            ...
            <div className="grid gap-4">
              <div className="bg-primary/5 border border-primary/20 rounded-lg p-4">
                <h4 className="text-primary font-medium mb-2">Access and Portability</h4>
                <p className="text-muted-foreground text-sm">
              ...
              <div className="bg-accent/10 border border-accent/20 rounded-lg p-4">
                <h4 className="text-accent-foreground font-medium mb-2">Correction and Updates</h4>
                <p className="text-muted-foreground text-sm">
              ...
              <div className="bg-destructive/5 border border-destructive/20 rounded-lg p-4">
                <h4 className="text-destructive font-medium mb-2">Deletion</h4>
                <p className="text-muted-foreground text-sm">
              ...
              <div className="bg-secondary border border-border rounded-lg p-4">
                <h4 className="text-foreground font-medium mb-2">Restrict Processing</h4>
                <p className="text-muted-foreground text-sm">
            ...
            <div className="bg-muted/50 rounded-lg p-4 mt-4">
              <h4 className="text-foreground font-medium mb-2">How to Exercise Your Rights</h4>
              <p className="text-sm text-muted-foreground">
                Contact us at <a href="mailto:privacy@monark.com" className="text-primary hover:underline">privacy@monark.com</a> or 
        ...
        <Card className="border-border">
          ...
          <CardContent className="text-muted-foreground space-y-4">
            <div className="space-y-4">
              <div>
                <h4 className="text-foreground font-medium mb-2">Active Accounts</h4>
                <p className="text-sm">
              ...
              <div>
                <h4 className="text-foreground font-medium mb-2">Deleted Accounts</h4>
                <p className="text-sm">
              ...
              <div>
                <h4 className="text-foreground font-medium mb-2">Safety and Security</h4>
                <p className="text-sm">
        ...
        <Card className="border-border">
          ...
          <CardContent className="text-muted-foreground space-y-4">
            ...
            <div className="bg-primary/5 border border-primary/20 rounded-lg p-4 mt-4">
              <p className="text-muted-foreground text-sm">
                <strong className="text-foreground">EU Users:</strong> Your data is protected under GDPR regardless of where it's processed. 
        ...
        <Card className="border-border">
          ...
          <CardContent className="text-muted-foreground space-y-4">
            ...
            <div className="space-y-3">
              <div className="bg-accent/10 border border-accent/20 rounded-lg p-4">
                <h4 className="text-accent-foreground font-medium mb-2">Notification Process</h4>
      ...
      <Card className="bg-primary/5 border-primary/20">
        <CardContent className="pt-6">
          <div className="text-center space-y-4">
            <h3 className="text-foreground font-medium">Privacy Questions or Concerns?</h3>
