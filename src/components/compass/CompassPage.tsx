                ...
                <div
                  ...
                  {cardinals.map((dir, i) => {
                        ...
                        <div className="absolute bottom-4 flex flex-col items-center pointer-events-none">
                                  <span className="text-xl font-serif font-semibold text-foreground leading-none">{reading}</span>span>
                                  <span className="text-[8px] font-caption text-muted-foreground/60 mt-0.5">READING</span>span>
                        </div>div>
                </div>div>
          </div>div>
        );
...
const PillarPill: React.FC<{ pillar: string; score: number; active: boolean }> = ({ pillar, score, active }) => (
    <motion.div
      ...
      {active && <Star className="w-2.5 h-2.5 fill-primary text-primary shrink-0" />}
        <span className="text-[11px] font-medium">{PILLAR_SHORT[pillar] ?? pillar}</span>span>
        <span className={`text-[10px] font-caption ${active ? 'text-primary/80' : 'text-muted-foreground/60'}`}>{score}</span>span>
    </motion.div>motion.div>
  );
                ...
                <AnimatePresence>
                  {open && (
                      <motion.div
                                    ...
                                    style={{ boxShadow: 'var(--shadow-elevated)' }}
                                  >
                                  <p className="text-xs text-muted-foreground leading-relaxed">{def}</p>p>
                      </motion.div>motion.div>
                    )}
          ...
          <div className="space-y-4">
            ...
            {loading ? (
                      ...
                      {displayItems.map((itinerary) => {
                                  ...
                                  return (
                                                  <motion.div
                                                                  ...
                                                                  <h4 className="font-serif text-sm font-semibold text-foreground leading-snug">{itinerary.title}</h4>h4>
                                                    {locationName && (
                    ...
                    <div className="text-center py-10 bg-card rounded-2xl border border-border/60">
                              ...
                              <p className="font-serif italic text-foreground text-base mb-2">No date plans yet.</p>p>
                              ...
                              <button
                                            ...
                                            className="inline-flex items-center gap-2 px-5 py-2 bg-primary text-primary-foreground font-body font-medium text-xs tracking-[0.12em] uppercase rounded-[40px] hover:bg-primary/90 transition-all"
                                          >
                ...
                <motion.button
                          ...
                          whileTap={{ scale: 0.98 }}
                          onClick={onNavigateCompass}
                          className="w-full flex items-center justify-between px-4 py-3.5 rounded-2xl text-left border border-primary/20 bg-primary/5 hover:bg-primary/10 transition-colors"
                        >
                        <div className="flex items-center gap-3">
                                  ...
                                  <div>
                                              ...
                                              <p className="text-[11px] text-muted-foreground mt-0.5">Find venues matched to your RIF reading</p>p>
                                  </div>div>
                        </div>div>
          ...
          <div className="min-h-full bg-background">
            {/* Header */}
                <div className="px-5 pt-6 pb-4 border-b border-border/40">
                        ...
                        <h1 className="font-serif text-2xl font-semibold text-foreground leading-tight">Compass</h1>h1>
                ...
                <AnimatePresence mode="wait">
                        ...
                        {/* Rose + bearing */}
                                  <div className="flex flex-col items-center gap-4">
                                                ...
                                                <div className="text-center">
                                                                ...
                                                                <h2 className="font-serif text-3xl font-semibold text-foreground">{bearing}</h2>h2>
                                                  {hasDrift && (
                                                      <motion.p
                                                                            initial={{ opacity: 0 }}
                                                                            animate={{ opacity: 1 }}
                                                                  ...
                                                                  <div className="flex items-center gap-2 mb-3">
                                                                    ...
                                                                    {isLock && (
                                                                        <span className="flex items-center gap-1 px-2 py-0.5 rounded-full bg-primary/10 border border-primary/20">
                                                                                              ...
                                                                                              <span className="text-[9px] font-caption text-primary tracking-wider">LOCK</span>span>
                                                                        </span>span>
                                                                                    )}
                                                                  </div>div>
                                                                  <motion.div
                                                                                    ...
                                                                                    <div className="flex items-start justify-between gap-3">
                                                                                                        ...
                                                                                                        <div className="flex items-center gap-1 shrink-0">
                                                                                                                              ...
                                                                                                                              <span className="text-xs text-muted-foreground">{trueNorth.city ?? 'Chicago'}</span>span>
                                                                                                          </div>div>
                                                                                      </div>div>
                  ...
                  {activeSection === 'plans' && (
                      <motion.div
                                    ...
                                    exit={{ opacity: 0, y: -12 }}
                                    transition={{ duration: 0.25 }}
                                    className="px-5 pt-6 space-y-6 pb-10"
                                  >
                                  <div>
                                                <div className="flex items-center gap-2 mb-1">
                                                                <CalendarCheck className="w-4 h-4 text-primary" />
                                                                <p className="text-[10px] font-caption text-primary tracking-widest uppercase">
                                                                                  Smart Date Planner
                                                                </p>p>
                                                </div>div>
                                                <h2 className="font-serif text-xl font-semibold text-foreground leading-tight">My Date Plans</h2>h2>
                                                <p className="text-sm text-muted-foreground mt-1 leading-snug">
                                                                Plans saved from Compass - confirmed or waiting, all in one place.
                                                </p>p>
                                  </div>div>
                        ...
                        {HOW_IT_WORKS.map(({ icon: Icon, heading, body, term, def }, i) => (
                                                  <motion.div
                                                                  ...
                                                                  <div className="flex items-start gap-4">
                                                                                    ...
                                                                                    <div className="flex-1 min-w-0">
                                                                                                        <h3 className="font-serif text-base font-semibold text-foreground mb-1">{heading}</h3>h3>
...
export default CompassPage;</div>
