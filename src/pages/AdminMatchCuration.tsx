          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Review smart match decisions — flag edge cases or override picks
              </p>
            </div>
          </div>
              ...
              {selected ? (
                ...
                <Card>
                  <CardContent className="py-16 text-center">
                    ...
                    <p className="font-medium text-foreground">Select a match decision to review</p>
                    <p className="text-sm text-muted-foreground mt-1">
                      Approve, reject, or flag any pick from this week’s smart matching
                    </p>
                  </CardContent>
                </Card>
              )}
